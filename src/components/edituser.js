...
function Edituser(){
    ...
    function getsingledata(){
        axios.get(`https://signin-app-backend.onrender.com/getsingleuser/${id}`).then(res=>{
            setnewdata({
                Name:res.data.name,
    ...
    function submitHandler(e){
        ...
        try{
            axios.put(`https://signin-app-backend.onrender.com/Edit/${id}`,updatedData);
            setnewdata({
                Name:"",
                Email:"",
                number:""
    ...
    function deleteuser(){
        try {
            axios.delete(`https://signin-app-backend.onrender.com/deleteuser/${id}`);
